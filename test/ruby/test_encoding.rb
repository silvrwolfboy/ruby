...
class TestEncoding < Test::Unit::TestCase
  ...
  def test_compatibility_mode
    assert_in_out_err(%W[-Itest/lib --encoding-compatibility #{File.expand_path('../enc/compatibility_mode.rb', __FILE__)}], "", /15 tests, 41 assertions, 0 failures, 0 errors, 0 skips/, [])
  end
end
